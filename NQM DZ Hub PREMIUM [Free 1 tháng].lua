local Library = loadstring(Game:HttpGet("https://raw.githubusercontent.com/12399nhan/NQM-DZ-Hub-PREMIUM-MOBILE-AND-PC-V5/refs/heads/main/_bapcornnew2.txt"))()
...
local Tab = {
    ...
    Animation = "Script Ver3"
    },
    Key = " {
    KeySystem = true,
    Title = "NQM DZ",
    Description = "",
    KeyLink = "https://yeumoney.com/G9f4",
    Keys = {"bcd0c02c45f0b05cd549609f1e794cca"},
    Notifi = {
    Notifications = true,
    CorrectKey = "Đang chạy menu NQM DZ [PREMIUM]",
    Incorrectkey = " Mật khẩu Sai",
